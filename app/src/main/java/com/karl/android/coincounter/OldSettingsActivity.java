...
public class OldSettingsActivity extends AppCompatActivity {
        ...
        builder.setTitle(getString(R.string.language_title))
                .setItems(languages, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(OldSettingsActivity.this, getString(R.string.language_title) + ": " + languages[which], Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void sendFeedback() {
        ...
        try {
            ...
            Toast.makeText(OldSettingsActivity.this, R.string.no_email_clients_installed, Toast.LENGTH_SHORT).show();
        }
    }
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            Toast.makeText(OldSettingsActivity.this, R.string.error + " " + e, Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            Toast.makeText(OldSettingsActivity.this, "Could not coneect to play store", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
    ...
    public void clearAllData() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        myDB.deleteAll();
                        Toast.makeText(OldSettingsActivity.this, R.string.done, Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
    ...
    public void showToast(String message) {
        Toast.makeText(OldSettingsActivity.this, message, Toast.LENGTH_SHORT).show();
    }
}
