...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if ( id == R.id.navigation_drawer_my_saves){
            fragmentManager.beginTransaction().replace(R.id.content_frame, new MySavesFragment()).commit();
        } else if (id == R.id.navigation_drawer_my_groupings){
            fragmentManager.beginTransaction().replace(R.id.content_frame, new MyGroupingsFragment()).commit();
        }
