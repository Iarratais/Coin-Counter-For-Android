...
public class OldMainActivity extends ActionBarActivity {
    ...
    public void AddData() {
        ...
        if (!isEmpty) {
            Save save = new Save();
            save.setDate(getFormatDate());
            save.setTitle(total_title_.getText().toString());
            save.setAmount(overlay.getText().toString());
            save.setComment(commentedit.getText().toString());
            boolean isInserted = myDB.insertData(save);
            if (isInserted) {Toast.makeText(OldMainActivity.this, R.string.add_data_success, Toast.LENGTH_SHORT).show();}
            else {Toast.makeText(OldMainActivity.this, R.string.add_data_error, Toast.LENGTH_SHORT).show();}
        }
    }
    ...
    public boolean checkIfEmpty() {
        if (total_title_.getText().toString().equals("")) {
            Toast.makeText(OldMainActivity.this, R.string.check_if_empty_title_error, Toast.LENGTH_SHORT).show();
            return true;
        } else if (toDouble(getTotal()) < 0.01) {
            Toast.makeText(OldMainActivity.this, R.string.check_if_empty_overlay_errror, Toast.LENGTH_SHORT).show();
            return true;
        } else {return false;}
    }
    ...
    public void showsaves() {
        if (!fieldsAreEmpty()) {
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(OldMainActivity.this, ShowSaves.class);
                            finish();
